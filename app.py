...
activity=st.sidebar.selectbox("Activity",["Sedentary","Light Active","Moderately Active","Very Active","Extra Active"])
...
tab1,tab2=st.tabs(["Diet Recommendtion","Health Assistance"])
if tab1:
...
if tab2:
   question= st.text_area("Ask About Health",placeholder="eg: Good Source Of Vegeterian Protien")
   if st.button("Ask AI"):
       db=load_rag()
